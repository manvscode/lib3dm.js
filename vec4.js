...
vec4.VEC4_XUNIT = vec4( 1, 0, 0, 0 );
vec4.VEC4_YUNIT = vec4( 0, 1, 0, 0 );
vec4.VEC4_ZUNIT = vec4( 0, 0, 1, 0 );
vec4.VEC4_WUNIT = vec4( 0, 0, 0, 1 );
...
vec4.prototype.is_normalized = function( ) {
    return (Math.abs(this.x - 1.0) < mathematics.SCALAR_EPSILON) &&
           ...
           (Math.abs(this.w - 1.0) < mathematics.SCALAR_EPSILON);
};
